"""Panel UI for Square for Restaurants Connector following UI_INTERFACE_STANDARD.md and AUTH_AND_CREDENTIALS_STANDARD.md."""
...
async def square_restaurants_sidebar(ctx, **kwargs) -> ui.UINode:
    return ui.Stack(
        direction="v",
        gap=3,
        align="stretch",
        children=[
            ui.Text("Square for Restaurants", variant="heading"),
            ui.Stack(
                direction="v",
                gap=1,
                align="stretch",
                children=[
                    ui.Text("Manage your Square for Restaurants connections and integrations.", variant="caption"),
                ]
            ),
            ui.Divider(),
            ui.Stack(
                ...
                children=[
                    ui.Button(
                        "Sign in with Square for Restaurants (OAuth / SSO)",
                        variant="primary",
                        size="sm",
                        icon="login"
                    ),
                                ...
                                children=[
                                    ...
                                    ui.Stack(
                                        ...
                                        children=[
                                            ...
                                            ui.Input(param_name="label", placeholder="e.g. Production Square for Restaurants"),
                                        ]
                                    ),
                                    ui.Stack(
                                        direction="v",
