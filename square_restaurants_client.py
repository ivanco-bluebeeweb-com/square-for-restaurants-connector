"""HTTP client for Square for Restaurants (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.square_restaurants.com"
...
class SquareforRestaurantsClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-square_restaurants/0.1.0"
        }
