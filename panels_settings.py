"""Settings panel for Square for Restaurants Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__square_restaurants_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=square_restaurants_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_square_restaurants"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Square for Restaurants Settings & Accounts", level=2),
